        ...
        <div
            ...
            >
                <div className='flex flex-row justify-between mb-10'>
                    <h2 className=' font-extrabold text-[var(--goldenish-text-color)] italic text-[3.7rem] uppercase leading-none tracking-wider font-[var(--josefin-font)] mt-[3rem] mb-[1rem]'>Anser<br/>Shafiq</h2>
                    <CloseMenu className='text-[2rem] text-[var(--goldenish-text-color)]' onClick={() => setMobileMenu(false)} />
                </div>
                <nav className='flex flex-col h-[55%]'>
                <h4  className='text-[2rem] tracking-wider uppercase font-[600] my-3 text-stone-300 josefin-font cursor-pointer transition-transform duration-[1s] ease-in-out hover:scale-[1.05] hover:border-b-2 hover: border-[var(--goldenish-text-color)] '>
                    <HashLink smooth to={'/#projects-section'} >
                        About
                    </HashLink>
                </h4>
